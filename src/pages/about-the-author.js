						...
						<div className="row" id={style.flexWrapper}>
							...
							<div className="col l6 m12 s12">
								<section className={style.contentSectionBiography}>
									...
									I was born in Welwyn Garden City, in Hertfordshire, England. My mother was English and my father was American, who met in England during WW2. On October 1st 1949, spent early years there from 3 to 7, moved with parents and older brother to the USA, as my grandfather almost died. Returning to England when 7 as parents divorced. Missed 2 years of early school due to age, went on to primary school, and secondary modern school in Welwyn, Hertfordshire, where I enjoyed English and Art. I wrote several notable essays, and my art was hung inside on school wall. Had Various jobs from Salesman, to trainee driver on British railroad, played semi-professional football. Enjoyed writing short stories and poetry, did nothing with them. Moved in 1976 to the USA, had job as Retail store manager, worked various retail, played soccer, and eventually became a referee in many many games from high school on up. Retired in 2016, where I started to write again. Asim's Extraordinary Journeys: Book 1 All for the Children, is my first published book.
									</p>
									...
									<div className={style.authorContainerName}>
										<h2 className={style.authorName}>Tommy Lee Davis</h2>
