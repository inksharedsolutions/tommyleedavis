						...
						<div className='col l6 m12 s12' id={style.info }>
							...
							<div className={style.socialMediacontainer}>
								<div className={style.infoFooter}>
									<p className={style.fontAwesomePargh}><span className={style.spanFonts}><i className="far fa-envelope"></i></span><a href="mailto:publish@stratton-press.com">publish@stratton-press.com</a></p>
			                        <p className={style.fontAwesomePargh}><span className={style.spanFonts}><i className="fas fa-phone"></i></span><a href="tel:8883237009">888-323-7009</a></p>
